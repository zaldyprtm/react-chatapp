...
const AdminLogin = ({ onAdminLogin }) => {
  ...
  return (
    <div className="min-h-screen mb-20 flex items-center justify-center bg-slate-800 ">
      <div className="  bg-gradient-to-r from-indigo-500 to-violet-900 p-8 rounded-xl shadow-xl w-80 md:w-96 z-30 h-full  max-w-sm mx-auto mt-48 placeholder:text-white mb-20">
